...
(function (t) {
    ...
    (function (n) {
        ...
        function C(d) {
            var b = this, a = Math.max(n.animObject(b.renderer.globalAnimation).duration,
                250), m = !b.hasRendered;
            ...
            w(b.series, function (c) {
                var e = c.options.label, d = c.labelBySeries, h = d && d.closest;
        ...
        var D = n.wrap, w = n.each, E = n.extend, y = n.isNumber, x = n.pick, z = n.Series, F = n.SVGRenderer,
            A = n.Chart;
        n.setOptions({
            plotOptions: {
                series: {
        ...
        z.prototype.getPointsOnGraph = function () {
            if (this.xAxis || this.yAxis) {
                var d = this.points, b, a, m = [], c, e, f, h;
                e = this.graph || this.area;
                f = e.element;
                var g = this.chart.inverted, q = this.xAxis;
                b = this.yAxis;
                var r = g ? b.pos : q.pos, g = g ? q.pos : b.pos, q = x(this.options.label.onArea,
                    !!this.area), u = b.getThreshold(this.options.threshold);
                if (this.getPointSpline && f.getPointAtLength && !q) {
                    e.toD && (a = e.attr("d"), e.attr({d: e.toD}));
                    h = f.getTotalLength();
                    for (c = 0; c < h; c += 16) b = f.getPointAtLength(c), m.push({
                        chartX: r + b.x,
                        chartY: g + b.y,
                        plotX: b.x,
                        plotY: b.y
                    ...
                    b.chartY = g + b.plotY;
                    m.push(b)
                } else for (h = d.length, c = 0; c < h; c += 1) {
                    b = d[c];
                    a = d[c - 1];
                    b.chartX = r + b.plotX;
                    b.chartY = g + b.plotY;
                    ...
                    if (0 < c && (e = Math.abs(b.chartX -
                            a.chartX), f = Math.abs(b.chartY - a.chartY), e = Math.max(e, f), 16 < e)) for (e = Math.ceil(e / 16), f = 1; f < e; f += 1) m.push({
        ...
        z.prototype.checkClearPoint = function (d, b, a, m) {
            var c =
                    Number.MAX_VALUE, e = Number.MAX_VALUE, f, h, g = this.options.label.connectorAllowed,
                q = x(this.options.label.onArea, !!this.area), r = this.chart, u, k, n, t, p, l;
            for (p = 0; p < r.boxesToAvoid.length; p += 1) if (k = r.boxesToAvoid[p], l = d + a.width, u = b, n = b + a.height, !(d > k.right || l < k.left || u > k.bottom || n < k.top)) return !1;
            for (p = 0; p < r.series.length; p += 1) if (u = r.series[p], k = u.interpolatedPoints, u.visible && k) {
                for (l = 1; l < k.length; l += 1) {
                    if (k[l].chartX >= d - 16 && k[l - 1].chartX <= d + a.width + 16) {
                        if (B(d, b, a.width, a.height, k[l - 1].chartX, k[l - 1].chartY,
                                k[l].chartX, k[l].chartY)) return !1;
                ...
                if (!q && g && this === u && (m && !f || c < Math.pow(this.options.label.connectorNeighbourDistance, 2))) {
                    for (l = 1; l < k.length; l += 1) f = Math.min(Math.pow(d + a.width / 2 - k[l].chartX, 2) + Math.pow(b + a.height / 2 - k[l].chartY, 2), Math.pow(d - k[l].chartX, 2) + Math.pow(b - k[l].chartY, 2), Math.pow(d +
            ...
            return !m || f ? {x: d, y: b, weight: c - (h ? e : 0), connectorPoint: h} : !1
        };
        A.prototype.drawSeriesLabels = function () {
            var d = this, b = this.labelSeries;
            d.boxesToAvoid = [];
            w(b, function (a) {
            ...
            w(d.series, function (a) {
                ...
                if (a.xAxis || a.yAxis) {
                    var c, e, f, h = [], g, q;
                    c = a.options.label;
                    var r = d.inverted, n = r ? a.yAxis.pos : a.xAxis.pos, k = r ? a.xAxis.pos : a.yAxis.pos,
                        t = d.inverted ? a.yAxis.len : a.xAxis.len, v = d.inverted ? a.xAxis.len : a.yAxis.len,
                        p = a.interpolatedPoints, l = x(c.onArea, !!a.area), r = a.labelBySeries;
                    e = c.minFontSize;
                    c = c.maxFontSize;
                    if (a.visible && !a.isSeriesBoosting && p) {
                        r || (a.labelBySeries = r = d.renderer.label(a.name, 0, -9999, "connector").css(E({
                            color: l ? d.renderer.getContrast(a.color) :
                                a.color
                        }, a.options.label.style)), e && c && r.css({fontSize: a.labelFontSize(e, c)}), r.attr({
                            padding: 0,
                            opacity: d.renderer.forExport ? 1 : 0,
                            stroke: a.color,
                            "stroke-width": 1,
                            zIndex: 3
                        }).add(a.group).animate({opacity: 1}, {duration: 200}));
                        c = r.getBBox();
                        c.width = Math.round(c.width);
                        for (q = p.length - 1; 0 < q; --q) l ? (e = p[q].chartX - c.width / 2, f = p[q].chartCenterY - c.height / 2) : (e = p[q].chartX + 3, f = p[q].chartY - c.height - 3, b(e, f, c) && (g = a.checkClearPoint(e, f, c)), g && h.push(g), e = p[q].chartX + 3, f = p[q].chartY + 3, b(e, f, c) && (g = a.checkClearPoint(e,
                        ...
                        if (!h.length && !l) for (e = n + t - c.width; e >= n; e -= 16) for (f = k; f < k + v - c.height; f += 16) (g = a.checkClearPoint(e, f, c, !0)) && h.push(g);
                        if (h.length) {
                            if (h.sort(function (a, b) {
                                    ...
                                    r.x), 2), Math.pow(Math.abs(g.y - r.y), 2))) p = {
                                opacity: d.renderer.forExport ? 1 : 0,
                                x: g.x - n,
                                y: g.y - k
                            }, l = {opacity: 1}, 10 >= h && (l = {
                        ...
                        } else r && (a.labelBySeries = r.destroy())
                    }
                }
            })
        };
