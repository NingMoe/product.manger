...
Color.prototype = {
	...
	clone: function () {
		...
		// making the final build way to big to embed in Chart-2.7.1.js. So let's do it manually,
...
/**
 * DOM event types -> Chart-2.7.1.js event types.
...
function initCanvas(canvas, config) {
	...
	// Chart-2.7.1.js modifies some canvas values that we want to restore on destroy
	canvas[EXPANDO_KEY] = {
		initial: {
			height: renderHeight,
			width: renderWidth,
...
/**
 * Plugin based on discussion from the following Chart-2.7.1.js issues:
...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		initialize: function() {
			if (!moment) {
				throw new Error('Chart.js - Moment.js could not be found! You must include it before Chart-2.7.1.js to use the time scale. Download at https://momentjs.com');
			}
