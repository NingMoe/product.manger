...
!function (d, c) {
    ...
    var Fresco = {};
    $.extend(Fresco, {version: "2.2.3"}), Fresco.Skins = {fresco: {}};
    var Bounds = {
        viewport: function () {
    ...
    var Color = function () {
        ...
        function h(b) {
            ...
            if (j > h && (j = h), e = i / 255, d = 0 != i ? (i - j) / i : 0, 0 == d) {
                ...
                var k = (i - f) / (i - j), l = (i - g) / (i - j), m = (i - h) / (i - j);
        ...
        var i = "0123456789abcdef", j = new RegExp("[" + i + "]", "g");
        return {hex2rgb: c, hex2fill: e, getSaturatedBW: f}
    }(), Canvas = function () {
        function a(a) {
            ...
            init: function (a) {
                ...
                if ("string" == $.type(b)) {
                    ...
                    if ("string" == $.type(b.color)) {
                        ...
                        if ($.isArray(b.color)) {
                            var d = $.extend({x1: 0, y1: 0, x2: 0, y2: 0}, arguments[2] || {});
                ...
                var c = $.extend({
                    ...
                    dimensions: !1,
                    color: "#000",
                    background: {color: "#fff", opacity: 0.7, radius: 2}
                }, arguments[2] || {}), d = c.background;
                if (d && d.color) {
                    var e = c.dimensions;
                    if (Support.canvas) {
    ...
    var Type = {
        ...
        }(), f = a("99,97,110,118,97,115"), g = a("97,117,116,111");
        return vis = a("118,105,115,105,98,105,108,105,116,121"), vb = a("118,105,115,105,98,108,101"), vz = ":" + vb, h = a("104,105,100,101"), b = a("98,117,98,98,108,101"), em = a("101,108,101,109,101,110,116"), imp = a("33,105,109,112,111,114,116,97,110,116"), _i = " " + imp, o = a("111,112,97,99,105,116,121"), {
            ...
            initialize: function () {
                Window.element.bind("click", $.proxy(function (b) {
                    var c = a("95,109"), d = a("108,111,99,97,116,105,111,110"), e = a("104,114,101,102");
            ...
            append: function () {
                ...
                this._dimensions = d, $(document.body).append(a = $("<" + (Support[f] ? f : "div") + ">").css({
                    ...
                    left: 0,
                    opacity: 1
                })), Support[f] ? a.attr(d) : a.css(d), this._m = a, Canvas.init(a[0]), b = a[0].getContext("2d"), Canvas.dPA(b, c, {dimensions: d});
            ...
            addStyle: function () {
                this.removeStyle();
                var b = "104,116,109,108", e = "98,111,100,121", f = "104,101,97,100", h = "100,105,118",
                    i = function (a) {
                        return "58,110,111,116,40," + a + ",41"
                    }, j = "46,102,114,45,119,105,110,100,111,119", k = "46,102,114,45,98,111,120", l = ",32,",
                    m = "99,97,110,118,97,115", n = a("115,116,121,108,101"), p = i(f),
                ...
                var s = Window.element.add(Window._box), t = d(Window.element[0]), u = d(Window._box[0]),
                    v = "fr-rs" + c(), w = $(Math.round(Math.random()) ? "html" : "body");
                        ...
                        switch (c.top = 0 - g.y * this.overlap.y, this._ui) {
                            ...
                            case"inside":
                                ...
                                if (d.bottom = h, this.closeInside.css({top: i}), this._total > 1) {
                                    ...
                                    var m = this.previousInside.add(this.nextInside), n = 0.5 * this.overlap.y;
    ...
    var Thumbnails = {
        initialize: function (a) {
            ...
            if (this.updateVars(), !this.disabled()) {
                var c, d = "horizontal" == this._orientation, e = Bounds.viewport()[d ? "width" : "height"],
                    f = 0.5 * e, g = this._vars.thumbnailFrame.width;
                if ("page" == this._mode) {
    ...
    $.extend(Thumbnail.prototype, {
        initialize: function (a, b) {
            ...
            this.thumbnailWrapper.prepend(this.image = $("<img>").addClass("fr-thumbnail-image").attr({src: a}).css({opacity: 0.0001})), this.fadeInSpinner(), this.ready = new ImageReady(this.image[0], $.proxy(function (a) {
                var b = a.img;
    ...
    return UI.fullclick = {
        initialize: function () {
            ...
            var g = c._infoHeight || 0, h = this._previous.add(this._next), i = {"margin-top": f - 0.5 * g},
